...
The demonstration video can be found [here](https://youtu.be/fz8gHNVGwDA) (https://youtu.be/fz8gHNVGwDA), the report PDF can be found [here](https://github.com/1105-Takamura-Kevin/CPE301-final/blob/main/Report/CPE301_Final.pdf), and the main Arduino file can be found [here](https://github.com/1105-Takamura-Kevin/CPE301-final/blob/main/Arduino%20files/CPE301final.ino).
<br><br>
